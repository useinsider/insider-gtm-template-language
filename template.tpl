...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Insider Page Language",
  ...
  "description": "This template gets the language of the website.",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    "type": "TEXT",
    "name": "lang",
    "displayName": "Language Variable Name",
    "simpleValueType": true,
    "defaultValue": "pageInfo.language"
  }
]
...
insiderObject.user = insiderObject.user || {};

insiderObject.user.language = getData(data.lang) || '';
...
Created on 11/20/2020, 3:02:01 PM
